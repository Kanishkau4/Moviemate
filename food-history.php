...
$query = "
    SELECT fo.*, f.name, f.price, f.image_url
    FROM food_orders fo
...
<head>
    ...
    <title>Food Order History - MovieMate</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <!-- Include the same CSS as movie-history.php but change relevant classes -->
    <style>
...
<body>
    ...
    <div class="history-container">
        <h1 class="history-title">
            <i class="fas fa-utensils"></i> Your Food Order History
        </h1>
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="history-card">
                    ...
                    <div class="movie-info">
                        ...
                        <p><i class="fas fa-calendar"></i> <?php echo date('F j, Y', strtotime($row['order_date'])); ?></p>
